    ...
    <div className="product-container">
        ...
        <div className='flex-1 flex flex-col'>
          ...
          <div className="product-info">
            <div className='flex flex-col gap-2'>
              <p className='text-secondary font-bold'>{product.currency} {formatNumber(product.currentPrice)}</p>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <p className='text-sm text-black opacity-50'><span className='text-primary-green font-semibold'>93%</span>buyers have recommended this.</p>
            </div>
          </div>
          <div className='my-7 flex flex-col gap-5'>
            <div className='flex gap-5 flex-wrap'>
              ...
              <PriceInfoCard title="Highest Price" iconSrc="/assets/icons/arrow-up.svg" value={`${product.currency} ${formatNumber(product.currentPrice)}`} />
      ...
      <div className="flex flex-col gap-16 ">
        <div className="flex flex-col gap-5">
          <h3 className="test-2xl text-secondary font-semibold">
            Product Description
          </h3>
          <div className="flex flex.col gap-4">
